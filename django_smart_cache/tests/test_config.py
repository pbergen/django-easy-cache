...
from django_smart_cache.config import SmartCacheConfig, get_config, reload_config


class TestSmartCacheConfig(TestCase):
    """Test cases for SmartCacheConfig"""

    def setUp(self):
        """Set up test fixtures"""
        # Reset singleton instance for each test
        SmartCacheConfig._instance = None

    def test_singleton_pattern(self):
        """Test that SmartCacheConfig implements singleton pattern"""
        config1 = SmartCacheConfig()
        config2 = SmartCacheConfig()
...
class TestConfigHelperFunctions(TestCase):
    ...
    def test_get_config_function(self):
        ...
        self.assertIsInstance(config, SmartCacheConfig)

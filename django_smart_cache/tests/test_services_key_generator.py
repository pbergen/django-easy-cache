...
from django_smart_cache.exceptions import CacheKeyValidationError
...
class TestKeyGenerator(TestCase):
    ...
    def test_init_default_prefix(self):
        ...
        self.assertEqual(generator.prefix, "smart_cache")
    ...
    def test_validate_cache_key_too_long(self):
        ...
        long_key = "smart_cache:" + "x" * 300  # Exceeds 250 char limit
    ...
    def test_validate_cache_key_problematic_chars(self):
        ...
        problematic_keys = [
            "smart_cache:key\nwith_newline",
            "smart_cache:key\rwith_carriage",
            "smart_cache:key\0with_null",
        ]

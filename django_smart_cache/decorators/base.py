...
from django_smart_cache import CacheKeyValidationError
from django_smart_cache.config import get_config
from django_smart_cache.services import AnalyticsTracker, KeyGenerator, StorageHandler
...
class BaseCacheDecorator:
    ...
    def __call__(self, func: Callable[..., Any]) -> Callable[..., Any]:
        ...
        wrapper._smart_cache_decorator = self  # type: ignore
        wrapper._smart_cache_original = func  # type: ignore
